...
ActiveRecord::Schema.define(version: 2022_01_13_233317) do
  ...
  create_table "company_admins", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["admin_id"], name: "index_company_admins_on_admin_id"
  ...
  add_foreign_key "oauth_applications", "companies", column: "resource_owner_id"
